...
export const tasks: Task[] = [
  ...
  },
  {
    id: uuidv4(),
    seq: 1,
    title: "Weekly meeting Agenda 2025-12-29",
    type: "update",
  ...
  },
  {
    id: uuidv4(),
    seq: 2,
    title: "견적서 작성, 전송 관련 테스트 케이스 작성 2025-12-29",
    type: "test case",
    startDate: new Date("2025-12-29"),
    complete: false,
  },
  {
    id: uuidv4(),
    seq: 1,
    title: "app beta 회원가입 되는지 확인 2025-12-27",
    type: "regression test",
  ...
  },
  {
    id: uuidv4(),
    seq: 2,
    title: "상담 예약 부터 결제, 리뷰 작성까지 버그 확인 2025-12-27",
    type: "regression test",
    startDate: new Date("2025-12-27"),
    complete: false,
  },
